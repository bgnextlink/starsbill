...
if ($step === 1) {
    ...
    if ($success) {
        ...
        echo "<a href='../admin/index.php' class='block text-center bg-cyan-500 hover:bg-cyan-600 text-slate-950 font-bold py-3 rounded-xl text-xs uppercase tracking-wider font-mono transition shadow-lg'>
